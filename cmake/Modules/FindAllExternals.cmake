...
set (GTEST_DIRECTORY "${SCREENGRABBER_ROOT}/dependencies_source/gtest-1.7.0")
...
macro(add_gtest)
	if (NOT TARGET gtest)
		add_subdirectory (${VENDOR_ROOT}/gtest ${CMAKE_BINARY_DIR}/gtest)
	endif()
	set(HDRS ${HDRS} ${VENDOR_ROOT}/gtest/include)
	set(LIBS ${LIBS} gtest)
endmacro()
